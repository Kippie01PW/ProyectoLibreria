...
?>
  ...
  <!--
  <div id="mensaje" style="display: none; color: green; font-size: 18px; margin-top: 20px; text-align: center;">
    Pedido realizado
  </div>-->
									...
									<!-- Script del mensaje "Pedido realizdo" --->
					
									<!--<script>
  document.getElementById("btnComprar").addEventListener("click", function(event) {
    event.preventDefault(); // Evita que se envíe el formulario al hacer clic (si estás usando formulario)
    document.getElementById("mensaje").style.display = "block"; // Muestra el mensaje
								...
								<div id="divpaypal">
									...
									<div id="paypal-btn-container" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
  											Procesar pedido
										</div>
									</a>
								-->
